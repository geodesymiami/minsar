...
def unpack(hdf5, slcname):
    ...
    # Concatenation: Skip overlapping data from subsequent frames only
    # Keep ALL of first frame, skip overlap from later frames
    print('\nConcatenating frames (skipping overlaps from subsequent frames)...')
