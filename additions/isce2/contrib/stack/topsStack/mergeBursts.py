...
def main(iargs=None):
    ...
    for swath in swathList:
        ...
        # MinSAR 1-burst: allow single-burst swath (minBurst==maxBurst); merge is then one burst.
        # Previously we skipped, which left frames empty and caused ValueError in mergeBurstsVirtual.
