...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    write_framepage_url.py hvGalapagos
    write_framepage_url.py hvGalapagos/*html
    write_framepage_url.py hvGalapagos/*html --outdir hvGalapagos
    cd hvGalapagos; write_framepage_url.py *html
        """
    )
