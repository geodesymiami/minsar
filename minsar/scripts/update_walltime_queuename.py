...
def main(iargs=None):
    ...
    parser.add_argument('--config', default='job_defaults.cfg', help='job defaults file in minsar/defaults (default: job_defaults.cfg)')
    ...
    new_walltime, new_queue = putils.compute_rerun_walltime_and_queue(inps.job_file_name, config_file=inps.config)
