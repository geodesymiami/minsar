...
| Order | File | Focus |
|-------|------|--------|
| 0 | [00_job_resources_foundation.md](./00_job_resources_foundation.md) | `JOB_SUBMIT` + `queues.cfg`; dolphin 1-node worker defaults |
| 1 | [01_cslc_launcher.md](./01_cslc_launcher.md) | Multi-node LAUNCHER for SAFE `create_cslc` |
| 2 | [02_dolphin_stage_split.md](./02_dolphin_stage_split.md) | Split dolphin into sequential SLURM stages |
