...
# Prefer JOBSCHEDULER_PROJECTNAME; fall back to legacy misspelling JOBSHEDULER_PROJECTNAME if set.
export JOBSCHEDULER_PROJECTNAME="${JOBSCHEDULER_PROJECTNAME:-${JOBSHEDULER_PROJECTNAME:-insarlab}}"
